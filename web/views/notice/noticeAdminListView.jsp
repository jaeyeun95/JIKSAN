	...
	<th width="70">조회수</th>
		...
		<% for(Notice n : list){ %>
			<tr>
					...
					<td align="center"><a href="/jiksan/ndetail.ad?notice_no=<%= n.getNoticeNo() %>"><%= n.getNoticeTitle()  %></a></td>
...
&nbsp;
<% } %>
   <input type="button"  value="글쓰기" onclick="javascript:location.href='/jiksan/views/notice/noticeAdminWrite.jsp'">
</div>
